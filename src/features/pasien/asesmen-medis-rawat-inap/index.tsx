...
import { getAsesmenDokterRanap } from '@/services/asesmen-dokter-ranap'
...
interface AsesmenAwalMedisRawatInapProps {
    isReport?: boolean
    noreg?: string
    no?: string
}

export default function AsesmenAwalMedisRawatInap({
    isReport = false,
    no,
    noreg,
}: AsesmenAwalMedisRawatInapProps) {
    // store
    ...
    const { data, isLoading, isError } = useQuery({
        ...
        queryFn: () => getAsesmenDokterRanap({ noreg: noreg! }),
        enabled: !!noreg,
    })
